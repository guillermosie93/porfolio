...
(function ($, Drupal) {
  ...
  Drupal.behaviors.porfolio = {
    attach: function (context, settings) {
      ...
      $('.animation-turn').mouseleave(function(){
        $(this).css({ 'transform': 'rotateZ(0deg)' })
      })
      $('.animation-jump').mouseleave(function(){
        $(this).css({ 'animation': 'none' })
      })
      $('card-skill-level').hover(function(){
        $('.animation-jump').css({ 'animation': 'jump' })
      })
      $('.animation-grow').mouseleave(function(){
